...
public:
	...
	int  InsertItem(int nItem, int nItemHeight = 20, CListContainerElementUI*pListItem = NULL);
	bool SetSubItem(int nItem, int nSubItem, LPCTSTR Text, LPCTSTR lpszName);
